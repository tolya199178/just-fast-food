	...
	else
	{
		switch ($goGatewayOutput->getStatusCode())
		{
			case 0:
				...
				$ActuallCrossReference = $tomTransactionOutputMessage->getCrossReference();
				//$CrossReference = $CrossReference.'-R';
				//error_log('R-'.$CrossReference,0);
