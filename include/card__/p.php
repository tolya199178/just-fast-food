...
<body <?= $BodyAttributes ?> style="background:#F0EEDF">
	...
	<?php
			...
			if ($TransactionSuccessful == false) {
				...
				$_SESSION['ORDER_TRANSACTION_DETAILS']['CrossReference'] = $CrossReference;
				$_SESSION['user_address'] = $_SESSION['PAY_POST_VALUE']['address'];
