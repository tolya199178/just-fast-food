...
$(document).ready(function () {
    ...
    $('li[data-action="show-hide-modal-cart"]').bind('touchstart click', function(e){

        e.stopPropagation();
        var modal_cart = $('section[data-content="modal-cart"]');
        if( modal_cart.is(":visible") !== false) {
            modal_cart.fadeOut();
        } else {
            modal_cart.fadeIn();
        }
    ...
    $(document).bind('touchstart click', function(e){
        ...
        /*
         ...
         console.log( $(e.target).parents('.Social_counters').length );
         */
        if( $(e.target).parents('.Social_counters').length !== 1 ) {
            ...
            $(this).parents('.whole-wrap').find('#meal-item-add').click( function() {
                ...
                $.ajax({
                    ...
                    success: function (e) {
                        ...
                        $('#cart-items, #header-cart-items').load("include/cart-items.php");
                        $('section[data-content="modal-cart"]').load("include/modal-cart.php");
