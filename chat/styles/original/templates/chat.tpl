...
${endif:canpost}${endif:agent}
		...
		<td align="center" class="copyr">${msg:chat.window.poweredby} <a id="poweredByLink" href="http://http://just-fastfood.com/" title="Mibew Community" target="_blank">Just-FastFood</a></td>
		<td align="right">
