	...
	<div id="header">
		<div id="title">
			<h1><img src="<?php echo $webimroot ?>/images/logo.gif" alt="" width="32" height="32" class="left" />
				<a href="#"><?php echo isset($page['headertitle']) ? 'Just-FastFood' : $page['title'] ?></a></h1>
		</div>
...
<div id="footer">
	<p id="legal"><a href="http://just-fastfood.com/" class="flink">Just-FastFood</a> | (c) 2012 Just-FastFood</p>
</div>
</body>
</html>