...
$update = false;
$successUpdateMsg = "";
$ARRAY = array('type_name' ,'type_email', 'type_password', 'type_picture', 'type_phoneno' ,'type_time','type_notes','type_charges' ,'type_steps', 'type_min_order' ,'type_opening_hours' ,'type_category', 'type_is_delivery' , 'type_special_offer' ,'type_status', 'type_food');
foreach($ARRAY as $v) {
  $ARRAYTEMP[$v] = '';
}
...
<head>
  ...
  <script type="text/javascript" src="js/zice.custom.js?v1.0.1"></script>
  ...
  if($INSERT == 'true') {
    if($result) {
      ...
      echo '<script type="text/javascript">window.onload = function() {showError("Error Inserting Restaurant",2000);}</script>';
    }
  }
...
<div class="inner">
  <div class="topcolumn">
    <div class="logo"></div>
    <ul id="shortcut">
      <li> <a href="dashbord" title="Back To home"> <i class="fa fa-home fa-2x"></i><strong>Home</strong> </a></li>
      <li> <a href="setting" title="Setting"> <i class="fa fa-connectdevelop fa-2x"></i><strong>Setting</strong></a></li>
    </ul>
  </div>
    ...
    <div id="uploadTab">
      <ul class="tabs">
        ...
        <?php if ($PARTNER == ""){ ?>
          ...
          <li><a href="#tab2" id="3"> Browse <i class="fa fa-send"></i></a>
                ...
                <form id="validation" method="post" action="menu-type"  enctype="multipart/form-data">
                  <fieldset>
                    ...
                    <div class="section last">
                      <label>Restaurant Name<small>Name of Restaurant (e.g KFC)</small></label>
                      <div>
                        <input type="text" class="validate[required] large" name="type_name" id="type_name" value="<?php echo $ARRAYTEMP['type_name']?>">
                      </div>
                    </div>
                    <div class="section last">
                      <label>Food Type <small>Dish Type e.g American, Chinese</small></label>

                      <div>
                        <input type="text" class="validate[required] large" name="type_food" id="type_food" value="<?php echo $ARRAYTEMP['type_food']?>">
                      </div>
                    </div>
                    <div class="section last">
                      <label>Restaurant Email<small>(Order will be sent to this email, also for login into Restaurant Profile)</small></label>
                      <div>
                    ...
                    <div class="section last">
                      <label>Restaurant PhoneNo<small>Orders will be sent to this no (takeaway restaurant)</small></label>
                      <div>
                    ...
                    <div class="section last">
                      <label>1 mile Delivery Time<small>approx (i.e : 45)</small></label>
                      <div>
            ...
            <div class="load_page">
              <form class="tableName toolbar">
                ...
                <script type="text/javascript">
                  var dataSend = [{'type_id':'ID','type_name':'Name', 'type_status':'Status','type_time':'1mile Delivery Time','type_notes':'Special Notes', 'type_category':'Category', 'type_food': 'Food Type'}];
                  $.ajax({
                    type: "POST",
