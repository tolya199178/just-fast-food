...
$ARRAY = array('user_fullname', 'user_screen_name', 'user_password', 'user_email', 'user_phoneno', 'user_address', 'user_address_1', 'user_city', 'user_post_code', 'user_dob', 'user_hear', 'user_verified', 'user_status');
...
if( isset($_SESSION['access_key']) && isset($_POST['access']) && ($_POST['access'] == $_SESSION['access_key']) && isset($_POST['SIGNUP']) ) {
    ...
    if($json_post) {
        ...
        $result = INSERT($value, 'user_test', 'unique', $extra);
                ...
                <div class="row">
                    <form class="form-horizontal signup-form" method="post" action="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input id="j_firstName" class="form-control" type="text" value="" title="Enter your Full name" placeholder="Enter your full name..." name="user_fullname"/>
                            </div>
                        </div>
                        <div class="form-group">
