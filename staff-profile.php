    ...
    <div class="explor box-wrap" style="margin-bottom:10px">
        ...
        <?php while ($new_order = $obj->fetch_db_assoc($toconfirm_obj)) { ?>
            <div class="myorderslist">
                ...
                <div class="txt-right b">Address
                    : <?php echo $new_order['order_address'] . ' ' . key(json_decode($new_order['order_postcode'], true)); ?></div>
                <div class="">Order Note From User: <span class="i b"><?php echo $new_order['order_note']; ?></span>
                </div>
    ...
    <div class="profile-container">
        <div class="sign-up-wrap">
            <form action="" method="post" id="signupForm">
                ...
                <div class="row">
                    <label for="staff_name">Full Name<span>*</span></label><input type="text" name="staff_name"
                                                                                  id="staff_name" class="input required"
                                                                                  value="<?php echo $ARRAYTEMP['staff_name']; ?>"/>
                </div>
                <div class="row">
                    <label for="staff_phoneno">Phone No<span>*</span></label><input type="text" name="staff_phoneno"
                                                                                    id="staff_phoneno"
                                                                                    class="input required"
                                                                                    value="<?php echo $ARRAYTEMP['staff_phoneno']; ?>"/>
                </div>
                <hr class="hr"/>
                <p class="small txt-right">Address:</p>

                <div class="row">
                    <label for="staff_address">Address<span>*</span></label><input type="text" name="staff_address"
                                                                                   id="staff_address"
                                                                                   class="input required"
                                                                                   value="<?php echo $ARRAYTEMP['staff_address']; ?>"/>
                </div>

                <div class="row">
                    <label for="staff_postcode">Post
                        Code<span>*</span></label><?php echo $ARRAYTEMP['staff_postcode']; ?>
        ...
        if ($obj->num_rows($value) < 1) {
            ...
            while ($res = $obj->fetch_db_assoc($value)) {
                ...
                <div class="myorderslist">
                    ...
                    ?>
                    <div class="txt-right b">Post Code
                        : <?php echo key(json_decode($res['order_postcode'], true)) ?></div>
    ...
    <div class="profile-container">
        ...
        <div class="sign-up-wrap">
            <form action="" method="post" id="updtPassForm">
                <div class="row">
                    <label for="o_staff_password">Current Password<span>*</span></label><input type="password"
                                                                                               name="o_staff_password"
                                                                                               id="o_staff_password"
                                                                                               class="input required"/>
                </div>
                <div class="row">
                    <label for="staff_password">New Password<span>*</span></label><input type="password"
                                                                                         name="staff_password"
                                                                                         id="staff_password"
                                                                                         class="input required"/>
                </div>
                <div class="row">
                    <label for="c_staff_password">Confirm Password<span>*</span></label><input type="password"
                                                                                               name="c_staff_password"
                                                                                               id="c_staff_password"
                                                                                               class="input required"/>
                </div>
                <div class="row">
