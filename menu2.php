            ...
            <ul class="list-group menu-items">
                ...
                while($resultItems = $obj->fetch_db_assoc($itemsvalue)) {
                    ...
                    <li class="list-group-item">
                                    <div class="modal item-modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                    <h4 class="modal-title"><?php echo $resultItems['item_name']?></h4>
                                                </div>
                                                <div class="modal-body">
                                                    <p><?php echo $resultItems['item_name']?></p>
                                                </div><!-- /.modaly-body -->
                        ...
                        <div class="whole-wrap">
                                    ...
                                    <div class="fl-left submenuItems" style="margin-top:5px">
                                        <?php while($res_subitem = $obj->fetch_db_assoc($valueOBJ_subitem)) {?>
                                            <div class="nextrow">
                                                ...
                                                <div class="adtocart fl-right">
                                                    <form action="javascript:;">
                                                        <input type="submit" value=" + " class="btn order-button" id="id<?php echo $resultItems['item_id'].'|'.$res_subitem['subitem_id']?>"/>
                                                    </form>
                                                </div>
                                                <div class="clr"></div>
                                            </div>
                            ...
                            <?php
                                ...
                                <div class="adtocart fl-right">
                                    <form action="javascript:;">
                                        <input type="submit" value=" + " title="Add <?= $resultItems['item_name'] .' To Cart'?>" class="btn order-button" id="id<?php echo $resultItems['item_id']?>"/>
                                    </form>
                                </div>
                                <?php if($isMeal) {?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function itemModal() {
            $('ul.menu-items .list-group-item').on('click', function(){
                $(this).find('.item-modal').modal();
                $(this).unbind('click');
            });
            itemModal();
        }
