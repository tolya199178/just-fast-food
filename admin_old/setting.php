<?php
	...
	$update = false;
	$successUpdateMsg = "";
	$ARRAY = array('admin_email','min_rest_distence','meta','keywords','process_fee','cash_verification_fee');
	if(isset($_POST['add'])) {
...
<html>
    ...
    <body class="dashborad">
        ...
        <div id="content">
                    ...
                    <ul id="shortcut">
                        <li>
                            <a href="dashbord" title="Back To home">
                                <img src="images/icon/shortcut/home.png" alt="home" /><strong>Home</strong>
                            </a>
                        </li>
                        <li>
                            <a href="setting" title="Setting">
                                <img src="images/icon/shortcut/setting.png" alt="setting" /><strong>Setting</strong>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="clear"></div>
            <div class="onecolumn">
                <div class="header"><span><span class="ico  gray connect"></span>Settings</span>
                </div>
                <!-- End header -->
                <div class="clear"></div>
                <div class="content">
                                ...
                                <div class="load_page">
                                    <form class="tableName toolbar" method="post" action="setting">
                                        <div class="section last">
                                            ...
                                            <div>
                                                <input type="text" class="large" name="meta" id="meta" value="<?php echo $ARRAYTEMP['meta']; ?>">
                                            </div>
                                        </div>
                                        <div class="section last">
                                            <label>Meta Keywords</label>
                                            <div>
                                                <input type="text" class="large" name="keywords" id="keywords" value="<?php echo $ARRAYTEMP['keywords']; ?>">
                                            </div>
                                        </div>
                                        <div class="section last">
                                        ...
                                        <div class="section last">
                                            ...
                                            <div>
                                                <input type="text" class="validate[required] sDec " name="min_rest_distence" id="min_rest_distence" value="<?php echo $ARRAYTEMP['min_rest_distence']; ?>">
                                            </div>
                                        </div>
										<div class="section last">
                                            <label>Card Processing Fee</label>
                                            <div>
                                                <input type="text" class="validate[required] sDec " name="process_fee" id="process_fee" value="<?php echo $ARRAYTEMP['process_fee']; ?>">
                                            </div>
                                        </div>
										<div class="section last">
                                            <label>Cash Verification Fee</label>
                                            <div>
                                                <input type="text" class="validate[required] sDec " name="cash_verification_fee" id="cash_verification_fee" value="<?php echo $ARRAYTEMP['cash_verification_fee']; ?>">
                                            </div>
                                        </div>
                                        <div class="section last">
