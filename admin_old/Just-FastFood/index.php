...
<form action="" method="post" name="post" class="text_field col-lg-6 input-group input-group-lg text-center" id="order-search" >

  <input type="text" name="ukpostcode" required="" id="postcodeuk" class="form-control text-center postcode" autocomplete="off" placeholder="Enter your postcode e.g PO5 4LN" style="font-size: 19px; font-family: segoe ui; font-weight: 700" >
  <input type="submit" name="submit" class="custom_submit_button yellow_btn text-center sbtn" value="Search">
</form>
...
<div class="payments"> NO CASH? NO PROBLEM! PAY BY CARD PAYPAL</div>
...
<div class="container">
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12"><h3 class="white">Do you Own A Restaurant ? Get more business...</h3></div>
...
<ul class="nav nav-pills" id="myTab">
  <li class="active"><a href="#resturant" data-toggle="tab">Browse by Restaurant</a></li>
  <li><a href="#cousine" data-toggle="tab">Browse by couzine</a></li>
  <li><a href="#City" data-toggle="tab">Browse by City</a></li>
 
</ul>

<div class="tab-content">
  <div class="tab-pane active" id="resturant">
  <div class="tabs_list">
  <ul>
...
<li>Burger King</li>
  ...
  <div class="tab-pane" id="cousine"><div class="tabs_list">
  <ul>
...
<li>Burger King</li>
  ...
  <div class="tab-pane" id="City"><div class="tabs_list">
  <ul>
