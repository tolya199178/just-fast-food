					...
					<div class="sign-up-wrap">
						<form action="<?php echo $_GET['go']?>" method="post" id="fForm">
							<div class="row">
								...
								?>
									Nearer Restaurant Distance From Your Postcode <strong><?php echo $_SESSION['CURRENT_POSTCODE']; ?></strong> approx : <strong><?php echo $_SESSION['DELIVERY_CHARGES'];?>KM</strong><br><br>
									Our 1KM distance delivery charges is &pound;<?php echo delivery_charges(); ?><br/><br/>
