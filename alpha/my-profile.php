  ...
  <head>
		<meta charset="UTF-8">
		<meta name="description" content="My Profile <?= getDataFromTable('setting','meta'); ?>">
		<meta name="keywords" content="My Profile, <?= getDataFromTable('setting','keywords'); ?>">
		  ...
		  <div class="wrapper ">
			  ...
			  <?php
				if(is_user_cash_verified($_SESSION['userId']) != 'true') {
					echo '<a href="cash-verify.php" class="btn">Verify Pay By Cash Now</a>';
				} else {
					echo '<span style="font-size:12px; color:#7B9726">* Verified Pay By Cash User</span>';
				}
			  ?>
			  </div>
			  <div class="clr"></div>
