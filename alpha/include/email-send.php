...
function SENDMAIL($GET ,$CC) {
	...
	switch($GET['type']) {
		case 'verify-acct':
			$MSG = '<strong>Thank you for your interest in Just-FastFood.com. Your Account is Created </strong><br/><br/>';
			$MSG .= 'Please follow this link to activate your account. <strong><a href="https://just-fastfood.com/?verify_email='.$GET['Verify_Code'].'">Verify My Email</a></strong><br/><br/>';
        ...
        case 'corporate_user':
            $MSG = '<strong>Thank you for signing up for your corporate account.</strong><br/></br/>';
            $MSG .= 'Your login information is below : ';
            $MSG .= 'Username '. $_GET['co_email'];
            $MSG .= 'Password '.$_GET['co_password'];
		...
		case 'new_order_takeaway':
			...
			$MSG .= 'Phone No : <strong>'.$GET['order_phoneno'].'</strong><br/><br/>';
																																	...
																																	<tbody>
																																		...
																																		<tr>
																																			<td style="LINE-HEIGHT:22px" valign="bottom" colspan="5">
																																				<br>The order is to be delivered as soon as possible.
