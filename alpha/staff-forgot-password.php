...
<head>
	<meta charset="UTF-8">
	<meta name="description" content="Staff Forgot Password, <?= getDataFromTable('setting','meta'); ?>">
	<meta name="keywords" content="Staff ForgotPassword, <?= getDataFromTable('setting','keywords'); ?>">
			...
			<div class="box-wrap ">
				<form action="" method="post" id="loginForm" class="login-wrap" style="width:71%">
					<div class="row" style="font-family: monospace">
						...
						<p>Password update link will be sent your email address</p>
					</div>
					<div class="row">
