...
function PPHttpPost($methodName_, $nvpStr_) {
	$environment = 'sandbox';
	$API_UserName = urlencode('awaisk_1349926600_biz_api1.yahoo.com');	$API_Password = urlencode('1349926631');	$API_Signature = urlencode('AFcWxV21C7fd0v3bYYYRCpSSRl31A4IYu3nowsFclMPQ81jktAn3aj3s');
