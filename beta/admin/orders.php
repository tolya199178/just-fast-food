<?php
	...
	$update = false;
	$successUpdateMsg = "";
	$ARRAY = array( 'staff_order_staff_id', 'staff_order_order_id', 'staff_order_status');
...
<head>
        ...
        <body class="dashborad">
            ...
            <div id="content">
				...
				<div class="clear"></div>
					<div class="onecolumn">
						<div class="header"><span><span class="ico  gray connect"></span>Setting</span>
						</div>
						<!-- End header -->
						<div class="clear"></div>
						<div class="content">
								...
								<form action="orders?type=complete" method="post">
									<div class="section last">
										<label for="">Set Auto Order Confirmation to Delivery Guy</label>
										<div>
											<?php
												$auto = '';
											...
											?>
											<input type="checkbox"  name="setting" class="on_off_checkbox"  value="on" <?php echo $auto; ?>/>
										</div>
									</div>
									<div class="section last">
					...
					<div class="onecolumn">
						<div class="header"><span><span class="ico  gray connect"></span>New Orders</span></div>
						<div class="clear"></div>
						<div class="content">
						<?php
							$NEW_ORDER = false;
					...
					<div class="onecolumn">
						<div class="header"><span><span class="ico  gray connect"></span>Orders</span>
						</div>
						<!-- End header -->
						<div class="clear"></div>
						<div class="content">
							...
							<div id="uploadTab">
								<ul class="tabs">
									<li><a href="#tab2" id="3"> Browse All<img src="images/icon/new.gif" width="20" height="9" /></a></li>
								...
								<div class="tab_container">
									...
									<div id="tab2" class="tab_content">
										...
										<ul class="uibutton-group">
											<li><span class="tip"><a class="uibutton icon add on_load"  name="#tab1"  title="Assign Order To Delivery Guy">Assign An Order</a></span></li>
										</ul>
										<?php }?>
										<div class="load_page">
											<form class="tableName toolbar">
												...
												<h3>All <?php if(isset($_GET['type']))  echo $_GET['type']; else echo '';?> Orders</h3>
												<?php
													if($complete) {
												...
												?>
												<script type="text/javascript">
													var dataSend = [{'order_id':'Order ID' ,'order_user_id':'User ID', 'order_total': 'Total Amount' ,'order_details':'Order Details', 'order_postcode':'Post Code' , 'order_address': 'Address' , 'order_status':'Status', 'order_date_added':'Dated'}];
													$.ajax({
														  type: "POST",
														  url: 'include/browse-table.php',
														  data: { col : dataSend, table : '`<?php echo $TABLE_NAME ?>`', status : 'order_status' , editURL : '', delColumn : '<?php echo $TABLE_ID ?>' , where : '<?php echo $where;?>  ORDER BY `order_date_added` DESC' , actualTable : '<?php echo $TABLE_NAME ?>'},
										...
										<div class="show_add" style=" display:none">
											  <ul class="uibutton-group" >
												<li><span class="tip"><a class="uibutton icon prev on_prev "  id="on_prev_pro" name="#tab2"  title="Go Back" >Go Back</a></span></li>
													...
													<div class="formEl_b">
														<form id="validation" method="post" action="orders?type=pending" enctype="multipart/form-data">
															<fieldset>
																...
																<div class="section last">
																	...
																	<div>
																		<select name="staff_order_order_id" data-placeholder="Choose an Order..." class="chzn-select">
																			...
																			?>
																				<option value="<?php echo $res['order_id'];?>">Order ID: <?php echo $res['order_id']. '  ______ User ID : ' .$res['order_user_id'] .'  ______  Order Total :  ' .$res['order_total'] .'&pound;  [' .$res['order_date_added'].']'; ?></option>
																			<?php
																				}
																			?>
																		</select>
																...
																<div class="section last">
																	<label>Choose an Delivery Guy</label>
																	<div>
																		<select name="staff_order_staff_id" data-placeholder="Choose a Delivery Guy..." class="chzn-select">
																			...
																			?>
																				<option value="<?php echo $res['staff_id'];?>"><?php echo  'ID :' . $res['staff_id'] . ' '. $res['staff_name'];?></option>
																			<?php
																				}
																			?>
																		</select>
																...
																<div class="section last">
																	...
																	<div> <a class="uibutton submit_form">GO</a></div>
																</div>
															</fieldset>
														</form>
													</div>
