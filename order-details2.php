<?php
	...
	$ARRAY = array('user_name', 'user_screen_name', 'user_password', 'user_email', 'user_phoneno', 'user_address', 'user_address_1', 'user_city', 'user_dob', 'user_hear','user_verified' ,'user_status');
...
<div class="wrapper">
    ...
    <div class="inner_title"><h2 class="text-center white">Complete Your <span>Order</span></h2></div>
    ...
    <div class="section_inner">
        ...
        <div class="container">
           ...
           <div class="col-md-12 explor">
				...
				<div class="box-wrap login-wrap">
					<form class="form-horizontal bv-form" action="login.php" method="post" id="order-login-form">
						...
						<div class="form-group has-feedback">
							<label class="col-lg-3 control-label b" for="email" >Email Address</label><input type="text" name="email" id="password" class="input required email form-control"/>
						</div>
						<div class="form-group has-feedback">
							<label class="col-lg-3 control-label b" for="password" >Password</label><input type="password" name="password" id="password" class="input required form-control"/>
						</div>
			...
			<div class="col-md-6 box-wrap sign-up-wrap">
					...
					<form class="form-horizontal signup-form bv-form" action="pay.php" method="post" <?php if(!$user) { echo 'id="order-sign-up-form"'; } else { echo 'id="order-confirm-delivery"'; } ?>>
						...
						<div class="form-group has-feedback">
							...
							<input type="text" name="user_fullname" id="user_fullname" class="input required form-control" value="<?php echo $ARRAYTEMP['user_screen_name'];?>"/>
						...
						<div class="form-group has-feedback">
							...
							<?php if(!$user) { ?>
                            <input name="user_post_code" id="user_postcode" class="input required form-control" value="<?php echo $_SESSION['CURRENT_POSTCODE'];?>" type="hidden" />
                            <?php } ?>
							</div>
