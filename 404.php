    ...
    <div class="section_inner" >
        <div class="container">
            <div class="col-sm-10">
                ...
                <p style="margin-bottom: 70px">If you feel something is missing that should be here, please contact us <a href="contact.php" class="i u">here</a> or speak to us <a href="#" onclick="return SnapEngage.startLink();">here</a> We are available online 12 hours daily.</p>
